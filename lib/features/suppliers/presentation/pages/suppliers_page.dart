...
import '../providers/suppliers_controller.dart';
...
class _SuppliersPageState extends ConsumerState<SuppliersPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const PageHeader(
          title: 'Suppliers',
          subtitle: 'Organize suppliers and prepare incoming invoices and purchases.',
        ),
        ...
        SearchToolbar(
          ...
          onSearchChanged: () {
            ref.read(suppliersSearchProvider.notifier).state = _searchCtrl.text.trim();
              ...
              data: (rows) {
                if (rows.isEmpty) {
                  return const EmptyPlaceholder(
                    ...
                    subtitle: 'Add suppliers for purchases, incoming invoices and reports.',
                  );
                }
  ...
  Future<void> _delete(Party item) async {
    ...
    await ref.read(suppliersControllerProvider.notifier).remove(item.id!);
    if (!mounted) return;
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    await ref.read(suppliersControllerProvider.notifier).save(party);
